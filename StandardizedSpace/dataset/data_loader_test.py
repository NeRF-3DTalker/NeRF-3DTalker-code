...
class Dataset(data.Dataset):
    ...
    def load_3dmm_params(self,index):
        ...
        para_3dmm_path = os.path.join('/home/dataset/Macron/png',dmm_name)
    ...
    def __getitem__(self, index):
        ...
        mask_name=str(index)+'.png'
        img_path = os.path.join('/home/dataset_jiaqiang/Obama/gen',img_name)
        mask_path = os.path.join('/home/dataset_jiaqiang/Obama/mask',mask_name)
        ...
        return img_tensor,mask_img,index,img_tensor_
        '''
        dmm_name=str(index) + '_nl3dmm.pkl'
        para_3dmm_path = os.path.join('/home/dataset/Obama/png',dmm_name)
        with open(para_3dmm_path, "rb") as f: nl3dmm_para_dict = pkl.load(f)
...
def get_dataloaders(args):
    ...
    train_dataset, val_dataset = torch.utils.data.random_split(train_data, [0, 1000])
