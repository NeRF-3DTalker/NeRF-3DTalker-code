...
class classifier_AU(nn.Module):
    def __init__(self):
        ...
        self.linear1  = nn.Sequential(nn.Linear(640 ,512), nn.LeakyReLU(0.2, True),nn.Dropout(p=0.5))
...
class VQAutoEncoder(BaseModel):
    ...
    def __init__(self, args):
        ...
        self.quantize = VectorQuantizer(args.n_embed,
                                        args.zquant_dim,
                                        beta=0.25)
        #self.classifier_AU1=classifier_AU()
        #self.classifier_AU2=classifier_AU()
        #self.classifier_AU3=classifier_AU()
        #self.classifier_AU4=classifier_AU()
        #self.classifier_AU5=classifier_AU()
