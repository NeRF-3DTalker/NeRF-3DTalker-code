...
def get_data_loader(    mode='train',
    ...
    if mode=='train':
        ...
        total_size = len(XGaze_dataset)
        train_size = int(0.95 * total_size)
        test_size = total_size - train_size
        train_indices = list(range(train_size))
        test_indices = list(range(train_size, total_size))
        train_dataset = Subset(XGaze_dataset, train_indices)#[train_size, validation_size])
        val_dataset = Subset(XGaze_dataset,test_indices)# [train_size, validation_size])
...
class GazeDataset_normailzed_from_hdf(Dataset):
    ...
    def __len__(self):
        return 2000#len(self.idx_to_kv)
    ...
    def __getitem__(self, idx):
        ...
        for i, (img_batch, mel_batch, frames, coords) in enumerate(tqdm(gen, 
            ...
            #print(mel_batch.shape) 1 1 80 16
            '''
            with torch.no_grad():
            ...
            for p, f, c in zip(pred, frames, coords):
                ...
                f[y1:y2, x1:x2] = p
                cv2.imwrite(os.path.join('/home/temp/' +str(idx)+ '.png'),f)
            ...
            '''
        wav_sadtalkerexp=self.sadtalkerexp.generate('/home/dataset/Macron/lipwav/' +str(idx)+ '.jpg', '/home/dataset/Macron/sadtalker/', 'crop', source_image_flag=True, pic_size=256)
        ...
        sadtalkerexp_=self.sadtalkerexp.generate(img_path, '/home/dataset/Macron/sadtalker/', 'crop', source_image_flag=True, pic_size=256)
